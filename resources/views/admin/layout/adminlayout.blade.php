    ...
    <aside
        ...
        <div class="sidenav-header">
            ...
            <a class="navbar-brand m-0" href=" " target="_blank">
                <img src="assets/img/small-logos/logo-webdev.svg" class="navbar-brand-img h-100" alt="main_logo">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse    " id="dashboardsExamples">
                        <ul class="nav ms-4">
                            <li class="nav-item ">
                                <a class="nav-link " href="{{ route('commen_item_creation') }}">
                                    <span class="sidenav-mini-icon"> L </span>
                                    <span class="sidenav-normal"> Commen </span>
                                </a>
                            </li>
                            <li class="nav-item  ">
                                <a class="nav-link  " href="{{ route('serial_item_creation') }}">
                                    <span class="sidenav-mini-icon"> D </span>
                                    <span class="sidenav-normal"> Serial no </span>
                                </a>
                            </li>
                            <li class="nav-item ">
                                <a class="nav-link " href="{{ route('vehicle_item_creation') }}">
                                    <span class="sidenav-mini-icon"> A </span>
                                    <span class="sidenav-normal"> Vehicle </span>
                                </a>
                            </li>  
                        </ul>
                    </div>
        ...
        <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl mt-3" id="navbarBlur"
            ...
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb">
                    ...
                    <a href="index.html">
                        <h6 class="font-weight-bolder text-white mb-md-0 mb-4">logo</h6>
                    </a>
                </nav>
                <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
                    ...
                    <ul class="navbar-nav  justify-content-end">
                        ...
                        <li class="nav-item pe-3 d-flex align-items-center">
                            <a href="cart.html" class="nav-link text-white p-0">
