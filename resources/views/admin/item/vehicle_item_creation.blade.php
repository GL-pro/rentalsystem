...
@section('admin_body_content')
    ...
    <div class="container-fluid py-4">
        <form action="">
            <div class="row">
                <div class="col-lg-8">
                    <h4 class="text-white">Vehicle Item</h4>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-4">
                                    <label class="mt-2">Vehicle No</label>
                                    <input class="form-control" type="text" value="20" />
                                </div>
                            </div>
                ...
                <div class="col-sm-4">
                    <div class="card">
                        <div class="card-body">
                            ...
                            {{-- <div class="row"> --}}
                            <div class="btn-group1 mt-2 row p-0 justify-content-around" role="group"
                                aria-label="Basic radio toggle group">
                                <input type="radio" class="btn-check1" id="btncheck1" name="btnradio" autocomplete="off">
            ...
            <div class="row mt-3">
                <div class="col-sm-12">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="font-weight-bolder">Document Details</h5>
                            <div class="row justify-content-around">
                                <div class="col-md-6 ">
                                    <div class=" row border pb-3 rounded ">
                                        <div class="col-md-8">
                                            <label class="mt-2">Rc Book</label>
                                            <input class="form-control" type="file" value="" />
                                        </div>
                                        <div class="col-md-4">
                                            <label class="mt-2">Exp Date</label>
                                            <input class="form-control" type="date" value="" />
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6 ">
                                    <div class=" row border pb-3 rounded ">
                                        <div class="col-md-8">
                                            <label class="mt-2">Incursions </label>
                                            <input class="form-control" type="file" value="" />
                                        </div>
                                        <div class="col-md-4">
                                            <label class="mt-2">Exp Date</label>
                                ...
                                <div class="col-md-6 ">
                                    <div class=" row border pb-3 rounded ">
                                        <div class="col-md-8">
                                            <label class="mt-2">Pollution  </label>
                                            <input class="form-control" type="file" value="" />
                                        </div>
                                        <div class="col-md-4">
                                            <label class="mt-2">Exp Date</label>
